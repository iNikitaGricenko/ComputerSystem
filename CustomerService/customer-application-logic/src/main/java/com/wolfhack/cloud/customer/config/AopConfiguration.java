package com.wolfhack.cloud.customer.config;
...
public class AopConfiguration {
	...
	@Pointcut("@annotation(com.wolfhack.cloud.customer.annotations.AopLog)")
	public void monitor() {
	}
	...
	@AfterThrowing("@annotation(com.wolfhack.cloud.customer.annotations.AopLog))")
	public void AfterThrowing(JoinPoint joinPoint) {
		log.info("{}.{} Throws exception", joinPoint.getTarget().getClass().getSimpleName(), joinPoint.getSignature().getName());
	}

	@Around("@annotation(com.wolfhack.cloud.customer.annotations.AopLog)")
