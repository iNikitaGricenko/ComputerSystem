...
class OrderRestControllerTest {
	...
	void getAll() throws Exception {
		...
		CustomerOrderRequestDTO requestDTO = new CustomerOrderRequestDTO("Historichna 84", "Some test description", PaymentMethod.MASTERCARD, Currency.EUR, "Zaporizhzhya", "Zaporizhzhya", "Ukraine", "69000", customer, Set.of(item));
