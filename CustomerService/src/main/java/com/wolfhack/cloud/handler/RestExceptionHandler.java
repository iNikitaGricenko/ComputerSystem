...
import com.wolfhack.cloud.exception.CustomerNotFoundException;
import com.wolfhack.cloud.exception.OrderNotFoundException;
import com.wolfhack.cloud.exception.ProductNotFoundException;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleOrderNotFound(OrderNotFoundException exception, WebRequest request) {
        return handleException(exception, request, exception.getStatus());
    }
